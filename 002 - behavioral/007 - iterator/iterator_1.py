...
class MyList(Iterable):
    ...
    def reverse_iterate(self) -> Iterator:
...
if __name__ == "__main__":
    ...
    iterable.add('Maria')
    iterable.add('Roberto')
    iterable.add('Joaquim')

    print('ROUBEI UM VALOR: ', next(iter(iterable)))
    ...
    for element in iterable.reverse_iterate():
        print(element)
